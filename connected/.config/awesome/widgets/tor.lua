...
-- local str
local tor_text_enable_icon = '<span foreground="'
    .. fg_enable
    .. '" background="'
    .. bg
    .. '">'
    .. tor_icon
    .. '</span>'
local tor_text_disable_icon = '<span foreground="'
    .. fg_disable
    .. '" background="'
    .. bg
    .. '">'
...
awful.widget.watch(
    os.getenv('HOME') .. '/.config/awesome/widgets/tor.sh check',
    60, -- 1m
...
function show_tor()
    awful.spawn.easy_async(
        os.getenv('HOME') .. '/.config/awesome/widgets/tor.sh ip',
...
tor_widget:connect_signal('mouse::enter', function()
    show_tor()
end)
