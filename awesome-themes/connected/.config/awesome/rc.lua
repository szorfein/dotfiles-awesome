...
awful.rules.rules = {
    ...
    { rule = { class = 'Brave-browser' }, properties = { screen = 1, tag = beautiful.tagnames[2] } },

    { rule = { instance = 'music*' }, properties = { screen = 1, tag = beautiful.tagnames[4] } },

    { rule = { class = 'Gimp' }, properties = { screen = 1, tag = beautiful.tagnames[5] } },

    { rule = { class = 'mail' }, properties = { screen = 1, tag = beautiful.tagnames[6] } },
    { rule = { class = 'chat' }, properties = { screen = 1, tag = beautiful.tagnames[6] } },
}
-- }}}
