...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ altkey, 'Control' }, 'Up', function()
        awful.spawn.with_shell('volume.sh -i 1')
    end, { description = 'increase volume', group = 'music' }),
    awful.key({ altkey, 'Control' }, 'Down', function()
        awful.spawn.with_shell('volume.sh -d 1')
    end, { description = 'lower volume', group = 'music' }),
    awful.key({ altkey, 'Control' }, 'Right', function()
        awful.spawn.with_shell('mpc next')
    end, { description = 'music next', group = 'music' }),
    awful.key({ altkey, 'Control' }, 'Left', function()
        awful.spawn.with_shell('mpc prev')
    end, { description = 'music prev', group = 'music' }),
    awful.key({ altkey, 'Control' }, 'd', function()
        awful.spawn.with_shell('mpc del 0')
    end, { description = 'delete current playlist', group = 'music' }),

    -- Brightness
    awful.key({ altgrkey }, 'F9', function()
        awful.spawn.with_shell('xbacklight +1')
    end, { description = 'light mode', group = 'brightness' }),
    awful.key({ altgrkey }, 'F8', function()
        awful.spawn.with_shell('xbacklight -1')
    end, { description = 'dark mode', group = 'brightness' })
