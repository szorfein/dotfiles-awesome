...
ncmpcpp_prev_icon:buttons(gears.table.join(awful.button({}, 1, function()
...
ncmpcpp_toggle_icon:buttons(gears.table.join(awful.button({}, 1, function()
...
ncmpcpp_next_icon:buttons(gears.table.join(awful.button({}, 1, function()
